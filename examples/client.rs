...
use bevy_spicy_networking_tokio_quinn::{TokioQuinnClientProvider, ClientNetworkSettings, ClientConfig};

mod shared;
use shared::configure_client;
...
fn main() {
    ...
    // `ClientMessage`s
    app.add_plugin(bevy_spicy_networking::ClientPlugin::<TokioQuinnClientProvider>::default());
    ...
    app.insert_resource(ClientNetworkSettings::new(
        configure_client(),
...
fn handle_connect_button(
    mut net: ResMut<NetworkClient<TokioQuinnClientProvider>>,
    settings: Res<ClientNetworkSettings>,
...
fn handle_message_button(
    net: Res<NetworkClient<TokioQuinnClientProvider>>,
